import { CreateGradeInput, GradeResponse, UpdateGradeInput } from "../../types/Grade";
...
// Create grade
export async function createGradeService(createGradeDTO: CreateGradeInput): Promise<GradeResponse> {
...
// Delete a grade
export async function deleteGradeService(
    id: string 
): Promise<GradeResponse> {
    const grade = await AppDataSource.createQueryBuilder()
        .softDelete()
